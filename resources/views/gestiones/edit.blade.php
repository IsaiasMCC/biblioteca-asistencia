...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> <a href="{{ route('gestiones.edit', $gestion->id) }}"> Editar </a> </li>
    </ol>
@endsection
                ...
                <form method="POST" action="{{ route('gestiones.update', $gestion->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('anio') is-invalid @enderror" id="anio"
                            aria-describedby="anio" name="anio" value="{{ old('anio', $gestion->anio) }}">
                        @error('anio')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('semestre') is-invalid @enderror" id="semestre"
                            aria-describedby="semestre" name="semestre" value="{{ old('semestre', $gestion->semestre) }}">
                        @error('semestre')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
