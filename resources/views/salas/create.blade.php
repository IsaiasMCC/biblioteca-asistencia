...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> <a href='{{ route('salas.create') }}'> Crear </a> </li>
    </ol>
@endsection
            ...
            <form method="POST" action="{{ route('salas.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre"
                        aria-describedby="nombre" name="nombre" value="{{ old('nombre') }}">
                    @error('nombre')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('capacidad') is-invalid @enderror" id="capacidad"
                        aria-describedby="capacidad" name="capacidad" value="{{ old('capacidad') }}">
                    @error('capacidad')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="ubicacion" class="form-control @error('ubicacion') is-invalid @enderror" id="ubicacion"
                        aria-describedby="ubicacion" name="ubicacion" value="{{ old('ubicacion') }}">
                    @error('ubicacion')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
